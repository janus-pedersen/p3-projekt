...
The watch is connected to the mobile network, which means it works everywhere, even outside the home. Should an incident occur away from the user’s residence, the signal is still sent to the relatives. The watch is also equipped with GPS, so relatives can always see the user’s position in real time.
