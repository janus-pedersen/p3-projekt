...
\hline
\end{tabular}
\caption{Representative wearable IMU fall detection results. Metrics reported by the original papers on their own protocols.}
\label{}
\end{table}