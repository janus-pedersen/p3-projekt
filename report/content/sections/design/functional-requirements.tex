...
I dette afsnit præsenteres designet af falddetekteringssystemet, Lapsus. Afnsittet tager særligt udgangspunkt i viden indhentet i afsnittet State of Art, samt det interview, der er blevet lavet med en bruger i målgruppen. Dette har sammen ført til udviklingen af funktionelle og ikke-funktionelle krav, som systemet skal formes ud fra. 

Derudover er der blevet udfærdiget en række userstories for de to brugerroller - user og relative, som har dannet baggrund for et use case diagram. 

Use case diagrammet og kravene til systemet er blevet brugt til at udfærdige et context diagram, som her giver et overordnet overblik over systemets funktionaliteter, samt sammenspillet mellem systemets forskellige komponenter. 
