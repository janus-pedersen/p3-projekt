...
These user stories form the basis for identifying the core interactions between actors and the system. In the following section, they are translated into a use case diagram, which provides a structured and visual representation of the system’s functional behavior.
