...
The enclosure consists of two parts: a base that holds the PCB and battery, and a top cover that protects the components while allowing interaction with the button. Openings for charging and ventilation were minimized to improve durability and support future waterproofing considerations.
