...
Throughout development, unit tests were an important part of validating the functionality of our system. We regrettably implemented the unit tests quite late, and were therefor not able to take full advantage of the bonuses that comes from having them. 
...
Since the tests were implemented quite late, it was only really for the last few days of development that any good came from them. Every time we changed the code, the tests were ran to verify that it was at least somewhat still functional. One such result could look something like the following (see fig).
...
> vitest
 ...
 DEV  v3.2.4 /Users/janus/Documents/GitHub/p3-projekt/code/app
 ...
 Test Files  8 passed (8)
      Tests  14 passed (14)
   Start at  15:35:39
   Duration  2.95s (transform 623ms, setup 1.03s, collect 2.25s, tests 2.08s, environment 2.64s, prepare 399ms)
\end{minted}