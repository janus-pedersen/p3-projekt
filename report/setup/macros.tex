...
\newcommand{\aautitlepage}[3]{%
  {
    ...
    \begin{tabular}{@{}ll@{}}
      \parbox{\titlepageleftcolumnwidth}{
        \iflanguage{danish}{%
          \includegraphics[width=\titlepageleftcolumnwidth]{report/AAUgraphics/aau_logo_da}
        }{%
          \includegraphics[width=\titlepageleftcolumnwidth]{report/AAUgraphics/aau_logo_en}
        }
      } &
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\insertcode}[2][typescript]{
  \begin{sourceblock}
    \captionof{source}{#2}
    \label{code:#2}
    \inputminted[
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\insertcodeblock}[5][typescript]{
  \begin{codeblock}
    \captionof{code}{#5  (\textit{#2} #3-#4)}
    \label{code-block:#2 (#3-#4)}
    \inputminted[
      frame=lines,
      framesep=2mm,
      baselinestretch=0.9,
...
% Macro: \wrapimage{side}{width}{path}{caption}{label}
\newcommand{\wrapimage}[4]{%
  \begin{wrapfigure}{#1}{0.5\textwidth}
    \centering
    \begin{minipage}{0.35\textwidth}
      \includegraphics[width=\linewidth]{#2}
      \captionsetup{width=\linewidth, justification=centering, font=footnotesize, labelfont=bf}
      \caption{#3}
      \label{fig:#4}
    \end{minipage}
  \end{wrapfigure}
